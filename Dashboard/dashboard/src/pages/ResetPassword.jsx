...
import SpecialLoadingButton from "./special_Components/SpecialLoadingButton";
...
const ResetPassword = () => {
  ...
  const handleResetPassword = (password, confirmPassword) => {
    dispatch(resetPassword(token, password, confirmPassowrd));
  };
      ...
      <div className=" min-h-[100vh] flex items-center justify-center py-12">
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid gap-4">
            ...
            {!loading ? (
              <Button
                onClick={() => handleResetPassword(password, confirmPassowrd)}
                className="w-full"
              >
                Reset Password
              </Button>
